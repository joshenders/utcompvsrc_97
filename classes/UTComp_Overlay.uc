...
// altered/recoded by Aaron 'Lotus' Everitt for use in UTCompvSrc
//-----------------------------------------------------------
...
function PostRender( canvas Canvas )
{
  ...
  /*     HealthOffset=Canvas.ClipX*0.16;
   ...
   if(ViewPortOwner.Actor.Level.TimeSeconds<OnJoinMessageDrawTime)
   {
       ...
       Canvas.DrawText("UTComp "$MakeColorCode(class'Hud'.Default.GoldColor)$"Src"$MakeColorCode(InfoTextColor)$".");
