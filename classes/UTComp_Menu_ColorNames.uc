...
function InitComponent(GUIController MyController, GUIComponent MyOwner)
{
     ...
     for(i=0; i<BS_xPlayer(PlayerOwner()).default.ColoredName.Length; i++)
     ...
     ch_ColorChat.Checked(class'BS_xPlayer'.default.bEnableColoredNamesInTalk);
     ch_ColorScoreboard.Checked(class'UTComp_ScoreBoard'.default.bEnableColoredNamesOnScoreboard);
     ch_ColorQ3.Checked(class'BS_xPlayer'.default.bAllowColoredMessages);
     ch_EnemyNames.Checked(class'BS_xPlayer'.default.bEnableColoredNamesOnEnemies);
...
function InitSliderAndLetters()
{
     ...
     {
          BS_xPlayer(PlayerOwner()).default.ColorName[i].A=255;     //make sure someone didnt change this
          ...
          l_ColorNameLetters[i].TextColor=BS_xPlayer(PlayerOwner()).default.ColorName[i];
...
function SpecialInitSliderAndLetters(int j)
{
     ...
     for(i=0; i<Len(BS_xPlayer(PlayerOwner()).default.ColoredName[j].SavedName); i++)
     {
          BS_xPlayer(PlayerOwner()).default.ColorName[i].A=255;     //make sure someone didnt change this
          l_ColorNameLetters[i].TextFont="UT2LargeFont";
          l_ColorNameLetters[i].WinTop=0.50;
          l_ColorNameLetters[i].WinWidth=0.029;
          l_ColorNameLetters[i].WinLeft=(0.50-(0.50*0.030*Len(BS_xPlayer(PlayerOwner()).default.ColoredName[j].SavedName))+(0.030*i));
          l_ColorNameLetters[i].StyleName="TextLabel";
          l_ColorNameLetters[i].Caption=Right(Left(BS_xPlayer(PlayerOwner()).default.ColoredName[j].SavedName, (i+1)), 1);
          l_ColorNameLetters[i].TextColor=BS_xPlayer(PlayerOwner()).default.ColoredName[j].SavedColor[i];
          l_ColorNameLetters[i].TextAlign=TXTA_Center;
     }
     for(i=Len(BS_xPlayer(PlayerOwner()).default.ColoredName[j].SavedName); i<20; i++)
          l_ColorNameLetters[i].Caption="";
...
{
    sl_RedColor.SetValue(class'BS_xPlayer'.default.colorname[offset].R);
    sl_BlueColor.SetValue(class'BS_xPlayer'.default.colorname[offset].B);
    sl_GreenColor.SetValue(class'BS_xPlayer'.default.colorname[offset].G);
}
...
function InternalOnChange( GUIComponent C )
{
    ...
    Switch(C)
    {
    case ch_ColorChat: class'BS_xPlayer'.default.bEnableColoredNamesInTalk=ch_ColorChat.IsChecked();  break;
    ...
    case ch_ColorQ3: class'BS_xPlayer'.default.bAllowColoredMessages=ch_ColorQ3.IsChecked(); break;
    case ch_EnemyNames: class'BS_xPlayer'.default.bEnableColoredNamesOnEnemies=ch_EnemyNames.IsChecked(); break;
 ...
 //   case ch_ColorDeath: class'UTComp_xDeathMessage'.default.drawcolorednamesindeathmessages=ch_ColorDeath.IsChecked(); break;
    ...
    case sl_RedColor:   class'BS_xPlayer'.default.ColorName[sl_LetterSelect.Value-1].R=sl_RedColor.Value;
    ...
    case sl_BlueColor:  class'BS_xPlayer'.default.ColorName[sl_LetterSelect.Value-1].B=sl_BlueColor.Value;
                        BS_xPlayer(PlayerOwner()).SetColoredNameOldStyle();
                        l_ColorNameLetters[sl_LetterSelect.Value-1].TextColor.B=sl_BlueColor.Value;  break;
    case sl_GreenColor: class'BS_xPlayer'.default.ColorName[sl_LetterSelect.Value-1].G=sl_GreenColor.Value;
                        BS_xPlayer(PlayerOwner()).SetColoredNameOldStyle();
...
function bool InternalOnClick( GUIComponent Sender )
{
    ...
    case bu_SaveName:
                       ...
                       co_SavedNames.AddItem(BS_xPlayer(PlayerOwner()).FindColoredName(BS_xPlayer(PlayerOwner()).default.ColoredName.Length-1));
                       co_SavedNames.ReadOnly(True); break;


    case bu_DeleteName:  if(BS_xPlayer(PlayerOwner()).default.ColoredName.Length>co_SavedNames.GetIndex() && co_SavedNames.GetIndex()>=0)
                             BS_xPlayer(PlayerOwner()).default.ColoredName.Remove(co_SavedNames.GetIndex(), 1);
                         BS_xPlayer(PlayerOwner()).ColoredName=BS_xPlayer(PlayerOwner()).default.ColoredName;
                         co_SavedNames.ReadOnly(False);
    ...
    case bu_ResetWhite:   for(i=0; i<20; i++)
                          {
                              BS_xPlayer(PlayerOwner()).default.colorname[i].R=255;
                              BS_xPlayer(PlayerOwner()).default.colorname[i].G=255;
                              BS_xPlayer(PlayerOwner()).default.colorname[i].B=255;
    ...
    case bu_Apply:
                    ...
                    BS_xPlayer(PlayerOwner()).default.CurrentSelectedColoredName=co_savedNames.GetIndex();
...
defaultproperties
{
     ...
     End Object
     l_ColorNameLetters(0)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label0'

     Begin Object Class=GUILabel Name=Label1
     End Object
     l_ColorNameLetters(1)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label1'

     Begin Object Class=GUILabel Name=Label2
     End Object
     l_ColorNameLetters(2)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label2'

     Begin Object Class=GUILabel Name=Label3
     End Object
     l_ColorNameLetters(3)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label3'

     Begin Object Class=GUILabel Name=Label4
     End Object
     l_ColorNameLetters(4)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label4'

     Begin Object Class=GUILabel Name=Label5
     End Object
     l_ColorNameLetters(5)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label5'

     Begin Object Class=GUILabel Name=Label6
     End Object
     l_ColorNameLetters(6)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label6'

     Begin Object Class=GUILabel Name=Label7
     End Object
     l_ColorNameLetters(7)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label7'

     Begin Object Class=GUILabel Name=Label8
     End Object
     l_ColorNameLetters(8)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label8'

     Begin Object Class=GUILabel Name=Label9
     End Object
     l_ColorNameLetters(9)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label9'

     Begin Object Class=GUILabel Name=Label10
     End Object
     l_ColorNameLetters(10)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label10'

     Begin Object Class=GUILabel Name=Label11
     End Object
     l_ColorNameLetters(11)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label11'

     Begin Object Class=GUILabel Name=Label12
     End Object
     l_ColorNameLetters(12)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label12'

     Begin Object Class=GUILabel Name=Label13
     End Object
     l_ColorNameLetters(13)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label13'

     Begin Object Class=GUILabel Name=Label14
     End Object
     l_ColorNameLetters(14)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label14'

     Begin Object Class=GUILabel Name=Label15
     End Object
     l_ColorNameLetters(15)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label15'

     Begin Object Class=GUILabel Name=Label16
     End Object
     l_ColorNameLetters(16)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label16'

     Begin Object Class=GUILabel Name=Label17
     End Object
     l_ColorNameLetters(17)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label17'

     Begin Object Class=GUILabel Name=Label18
     End Object
     l_ColorNameLetters(18)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label18'

     Begin Object Class=GUILabel Name=Label19
     End Object
     l_ColorNameLetters(19)=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.Label19'
     ...
     End Object
     ch_ColorChat=moCheckBox'UTCompvSrc.UTComp_Menu_ColorNames.ColorChatCheck'
     ...
     Begin Object Class=moCheckBox Name=ColorScoreboardCheck
         ...
         OnChange=UTComp_Menu_ColorNames.InternalOnChange
     End Object
     ch_ColorScoreboard=moCheckBox'UTCompvSrc.UTComp_Menu_ColorNames.ColorScoreboardCheck'
     ...
     Begin Object Class=moCheckBox Name=Colorq3Check
        ...
        OnChange=UTComp_Menu_ColorNames.InternalOnChange
     End Object
     ch_ColorQ3=moCheckBox'UTCompvSrc.UTComp_Menu_ColorNames.Colorq3Check'
     ...
     Begin Object Class=moCheckBox Name=EnemyNamesCheck
         ...
         OnChange=UTComp_Menu_ColorNames.InternalOnChange
     End Object
     ch_EnemyNames=moCheckBox'UTCompvSrc.UTComp_Menu_ColorNames.EnemyNamesCheck'
     ...
     End Object
     co_SavedNames=GUIComboBox'UTCompvSrc.UTComp_Menu_ColorNames.ComboSaved'
     ...
     End Object
     bu_SaveName=GUIButton'UTCompvSrc.UTComp_Menu_ColorNames.ButtonSave'
     ...
     End Object
     bu_DeleteName=GUIButton'UTCompvSrc.UTComp_Menu_ColorNames.ButtonDelete'
     ...
     End Object
     bu_ResetWhite=GUIButton'UTCompvSrc.UTComp_Menu_ColorNames.ButtonWhite'
     ...
     End Object
     bu_Apply=GUIButton'UTCompvSrc.UTComp_Menu_ColorNames.ButtonApply'
     ...
     End Object
     sl_RedColor=GUISlider'UTCompvSrc.UTComp_Menu_ColorNames.RedSlider'
     ...
     End Object
     sl_BlueColor=GUISlider'UTCompvSrc.UTComp_Menu_ColorNames.BlueSlider'
     ...
     End Object
     sl_GreenColor=GUISlider'UTCompvSrc.UTComp_Menu_ColorNames.GreenSlider'
     ...
     Begin Object Class=GUILabel Name=RedLabel
         ...
         WinLeft=0.528125
     End Object
     l_RedLabel=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.RedLabel'
     ...
     Begin Object Class=GUILabel Name=BlueLabel
         ...
         WinLeft=0.528125
     End Object
     l_BlueLabel=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.BlueLabel'
     ...
     Begin Object Class=GUILabel Name=GreenLabel
         ...
         WinLeft=0.528125
     End Object
     l_GreenLabel=GUILabel'UTCompvSrc.UTComp_Menu_ColorNames.GreenLabel'
     ...
     End Object
     sl_LetterSelect=GUISlider'UTCompvSrc.UTComp_Menu_ColorNames.LetterSlider'
     ...
     Begin Object Class=moComboBox Name=ColorDeathCombo
		...
		WinTop=0.467990
         OnChange=UTComp_Menu_ColorNames.InternalOnChange
     End Object
     co_DeathSelect=moComboBox'UTCompvSrc.UTComp_Menu_ColorNames.ColorDeathCombo'
