...
DefaultProperties
{
    PickupClass=Class'UTCompvSrc.NewNet_RocketLauncherPickup'
    FireModeClass(0)=class'UTCompvSrc.NewNet_RocketFire'
    FireModeClass(1)=class'UTCompvSrc.NewNet_RocketMultiFire'
}
