...
defaultproperties
{
    FireModeClass(0)=class'UTCompvSrc.NewNet_FlakFire'
    FireModeClass(1)=class'UTCompvSrc.NewNet_FlakAltFire'
    PickupClass=Class'UTCompvSrc.NewNet_FlakCannonPickup'
}
