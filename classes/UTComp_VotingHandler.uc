...
function bool StartVote(byte b, byte p, string Options, optional byte P2, optional string Options2, optional bool bAdminBypass)
{
...
function NotifyPlayersStart()
{
    ...
    Level.Game.Broadcast(Self, "A vote has started, press F5 to vote.");
}
